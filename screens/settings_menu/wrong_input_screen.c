...
void create_sprite_settings_error(scene *d)
{
    ...
    create_btn_text(d, "INPUT IS NOT VALID!", 60, create_vector2f(760, 500));
    create_btn_text(d, "(press any key to disable this error message)", 20, create_vector2f(785, 620));
}
