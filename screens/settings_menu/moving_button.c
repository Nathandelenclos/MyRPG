...
void create_button_setting_basic(scene *d)
{
    create_sprite_lb(d, "white_lb", create_btn_param(965, 355, 1, 3),
        TOUCH[d->hub->s->c->up]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 455, 1, 3),
        TOUCH[d->hub->s->c->down]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 555, 1, 3),
        TOUCH[d->hub->s->c->left]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 655, 1, 3),
        TOUCH[d->hub->s->c->right]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 755, 1, 3),
        TOUCH[d->hub->s->c->run]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 855, 1, 3),
        TOUCH[d->hub->s->c->interact]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 955, 1, 3),
        TOUCH[d->hub->s->c->attack]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 1055, 1, 3),
        TOUCH[d->hub->s->c->menu]);
    create_sprite_lb(d, "white_lb", create_btn_param(965, 1155, 1, 3),
        TOUCH[d->hub->s->c->screen]);
}
