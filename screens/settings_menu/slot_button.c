...
{
    create_btn_text(d, "INVENTORY", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(875, 1245));
    create_btn_text(d, "Slot 1:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1350));
    create_btn_text(d, "Slot 2:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1450));
    create_btn_text(d, "Slot 3:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1550));
    create_btn_text(d, "Slot 4:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1650));
    create_btn_text(d, "Slot 5:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1750));
    create_btn_text(d, "Slot 6:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1850));
    create_btn_text(d, "Slot 7:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 1950));
    create_btn_text(d, "Slot 8:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 2050));
    create_btn_text(d, "Slot 9:", create_text_id_struct(50, SCROLL_BTN_IN, 1), create_vector2f(700, 2150));
