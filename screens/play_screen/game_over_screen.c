...
void create_data_game_over(scene *d)
{
    ...
    create_btn_text(d, "GAME OVER",
    create_text_id_struct(120, UI, 3), create_vector2f(740, 450));
    create_btn_text(d, "RESPAWN",
    ...
    create_btn_param(create_vector2f(598.5, 945), 2, 5, HOME_BTN), "RESPAWN");
    create_sprite_lb(d, "white_lb",
