...
void create_data_pause(scene *d)
{
    ...
    create_btn_text(d, "MAIN MENU", create_text_id_struct(65, HOME_BTN, 2), create_vector2f(840, 743));
    ...
    create_sprite_lb(d, "white_lb",
        ...
        " SETTINGS");
    create_sprite_lb(d, "white_lb",
        create_btn_param(create_vector2f(822.5, 740), 1, 5, HOME_BTN), "MAIN MENU");
}
