...
void create_data(scene *d)
{
    ...
    create_btn_text(d, "   PLAY", 95, create_vector2f(822.5, 480));
    create_btn_text(d, " SETTINGS", 80, create_vector2f(822.5, 610));
    create_btn_text(d, "   QUIT", 100, create_vector2f(822.5, 715));
